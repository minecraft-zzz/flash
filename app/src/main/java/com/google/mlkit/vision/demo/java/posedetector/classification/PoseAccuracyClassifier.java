...
public class PoseAccuracyClassifier {
    private static final String TAG = "PoseAccurateClassifier";
    ...
    public PoseAccuracyClassifier(List<PoseSample> poseSamples) {
        this(poseSamples, MAX_DISTANCE_TOP_K, MEAN_DISTANCE_TOP_K, AXES_WEIGHTS);
    }

    public PoseAccuracyClassifier(List<PoseSample> poseSamples, int maxDistanceTopK,
