...
public class ChatActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Chatlist C1;
        C1=new Chatlist("Flash小助理：","您好，我是你的私人健身管家，请问有什么可以帮到您的呢");
        mDatas.add(C1);
//        Chatlist C2;
...
//        mDatas.add(C2);
        ...
        String apikey = preferences.getString("API_Key", "QEIGdgKkKtVcgAryEoBi9Qn5");
        String secretkey = preferences.getString("Secret_Key", "HiP4fFcqYHlVQonGtmbKx3dD2df5YnzZ");
        String airole = preferences.getString("Role", "你的名字是Flash，你是一个健身计划辅助规划助手");
              ...
              //  lo_msgloading.setVisibility(View.VISIBLE);
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        //获取到文心一言的回答
                        try {
                            wxresult = wx.GetAnswer(user_ask);
                        } catch (IOException | JSONException e) {
                            throw new RuntimeException(e);
                        } finally {
                        }

                        //MaryLink.getInstance().startTTS(wxresult);
